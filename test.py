...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default='/data/lijinyang/SleepSLeep/results/2025-10-14_09-42-44/run__fold0__20251014-094245/fold0_tacc_0.77675_tf1_0.72045_run__fold0__20251014-094245.pth', help='model_dir')
    parser.add_argument('--num_workers', type=int, default=16, help='num_workers')
    parser.add_argument('--label_smoothing', type=float, default=0, help='label_smoothing')
    parser.add_argument('--model_path', type=str, default='/data/lijinyang/SleepSLeep/results/2025-10-14_09-42-44/run__fold0__20251014-094245/fold0_tacc_0.77675_tf1_0.72045_run__fold0__20251014-094245.pth', help='model_path')
